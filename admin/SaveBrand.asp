...
conn.close
set conn=nothing
response.Write "<script language='javascript'>alert('品牌设置成功!！');window.location.href='ManageBrand.asp';</script>"
response.End
end if
...
conn.close
set conn=nothing
response.Write "<script language='javascript'>alert('品牌添加成功!！');window.location.href='ManageBrand.asp';</script>"
response.End
end if
%>