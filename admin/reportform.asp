...
<tr> 
<td colspan="4" align="center" height="24" background="../images/admin_bg_1.gif"><b><font color="#ffffff">销售统计</font></b></td>
</tr>
<tr>
<%
...
<tr align="center" > 
<td width="11%" bgcolor="fbc2c2">商品ID</td>
<td width="41%" bgcolor="fbc2c2">商品名称</td>
<td width="17%" bgcolor="fbc2c2">商品单位</td>
<td width="14%" bgcolor="fbc2c2">销售数量</td>
<td width="17%" bgcolor="fbc2c2">销售额</td>
</tr>
                                <%
									z_xs_sl=0
									z_xs_je=0
